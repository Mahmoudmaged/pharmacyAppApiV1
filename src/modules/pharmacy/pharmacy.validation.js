...
export const approvePharmacy = joi
  .object({
    pharmacyId: generalFields.id,
  })
  .required();
...
export const employeeLogin = joi
  .object({
...
export const requestNewAccessToken = joi
  .object({
    token: joi.string().required(),
  })
  .required();

export const registerAdmin = joi
  .object({
    country: joi.string().required(),
